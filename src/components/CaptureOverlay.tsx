...
const CaptureOverlay = ({ onRecord, onWrite, onClose }: CaptureOverlayProps) => {
      ...
      <div className="text-center max-w-lg mx-auto px-6">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center">
          ...
          >
            ...
            <span className="text-sm text-foreground/60 text-center">{t('captureOverlay', 'recordDesc')}</span>
          </button>
          ...
          >
            ...
            <span className="text-sm text-foreground/60 text-center">{t('captureOverlay', 'writeDesc')}</span>
          </button>
        </div>
      </div>
    </div>
